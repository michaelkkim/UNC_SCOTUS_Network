#setwd("C:/Users/michael/Desktop/Scotus_Network_2/scotus/with_node_attributes/shiny_michael5_in_deg")
...
shinyServer(function(input, output) {
  ...
  output$animationPlot <- renderPlot({
    hist(datasetInput2(), 
         breaks = 39450,
         xlim = c(0, 300),
         xlab = paste("in-degree of ", input$animation),
         ylim = c(0,100),
         main = paste("Histogram of In-Degrees in ", input$animation, " of SCOTUS Network"),
         col =  "#FB8072",
             border =  "#FB8072"
...
shinyUI(fluidPage(
    ...
    # Application title
    titlePanel("Histogram of In-Degrees for Each Year of SCOTUS Network"),
